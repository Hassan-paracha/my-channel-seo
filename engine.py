...
CHANNEL_HANDLE = "@HassanParacha-c3g"  # Your active @handle
DB_FILE = "video_db.json"
DAILY_INDEX_LIMIT = 18                 # Throttled down to ensure organic growth recovery
BATCH_SIZE = 3                         # Safe, human-like batching
COOLDOWN = 120                         # 2 minutes delay between batches to protect domain authority
